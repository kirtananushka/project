...
public class FindAllManagersCommand implements Command {
	...
	public Router execute(SessionContent content) throws CommandException {
		...
		if (role != null &&
			...
			router.setPageToGo(PageName.ALL_MANAGERS_PAGE);
			try {
				List<Manager> managersList = managerService.findAllManagers();
				...
				throw new CommandException("Exception while finding all managers.", e);
			}
		}
		return router;
	}
