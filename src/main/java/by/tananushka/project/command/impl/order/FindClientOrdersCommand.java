...
public class FindClientOrdersCommand implements Command {
	...
	public Router execute(SessionContent content) throws CommandException {
		...
		if (role != null && role.equals(UserRole.CLIENT.toString())) {
			router.setPageToGo(PageName.CLIENT_ORDERS_PAGE);
			try {
				List<TicketOrder> ordersList = orderService.findOrdersByClientId(content);
