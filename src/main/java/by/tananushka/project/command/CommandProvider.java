...
import by.tananushka.project.command.impl.order.FindAllOrdersCommand;
import by.tananushka.project.command.impl.order.FindClientOrdersByIdCommand;
import by.tananushka.project.command.impl.order.FindClientOrdersCommand;
import by.tananushka.project.command.impl.order.MakePaymentCommand;
import by.tananushka.project.command.impl.order.PrepareBuyingTicketsCommand;
import by.tananushka.project.command.impl.order.PreparePaymentCommand;
...
import by.tananushka.project.command.impl.user.ChangePasswordCommand;
...
import by.tananushka.project.command.impl.user.PrepareChangePasswordCommand;
...
public class CommandProvider {
	...
	private CommandProvider() {
		...
		commands.put(CommandName.ALL_ORDERS, new FindAllOrdersCommand());
		commands.put(CommandName.AUTHENTICATION, new AuthenticationCommand());
		commands.put(CommandName.BUY_TICKETS, new PrepareBuyingTicketsCommand());
		commands.put(CommandName.CLIENT_ORDERS, new FindClientOrdersCommand());
		...
		commands.put(CommandName.PREPARE_CHANGE_PASSWORD, new PrepareChangePasswordCommand());
		...
		commands.put(CommandName.PREPARE_PAYMENT, new PreparePaymentCommand());
		...
		commands.put(CommandName.SINGLE_CLIENT_ORDERS, new FindClientOrdersByIdCommand());
