...
<fmt:message key="genre.create" bundle="${resourceBundle}" var="title"/>
...
<div class="outer">
    <div class="center-padding grey shadow width50 back-white">
        <div class="padding-top-40">
            <form id="createGenreForm" name="createGenreForm"
                  action="${pageContext.request.contextPath}controller"
                  method="post">
                <input type="hidden" name="command" value="add_genre">
                <p class="noteRed">
                    <c:if test="${sessionScope.errCreateGenreMessage != null}">
                        <c:forEach var="errorMessages" items="${sessionScope.errCreateGenreMessage}">
