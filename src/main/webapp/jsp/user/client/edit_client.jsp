            ...
            <form id="regForm" name="regForm" class="authentication registration"
                ...
                <input class="inputField" type="text" id="name"
                       ...
                       placeholder=${namePlaceholder}
                               value="${requestScope.client.name}" required
                       title=${name}>
                ...
                <input class="inputField" type="text" id="surname"
                       ...
                       placeholder=${surnamePlaceholder}
                               value="${requestScope.client.surname}" required
                       title=${surname}>
                <label class="explanation">${nameExpl}</label>
                <br>
                ...
                <input class="inputField" type="tel" id="phone"
                       ...
                       placeholder=${phonePlaceholder}
                               value="${requestScope.client.phone}" required
                       title=${phone}>
                ...
                <input class="inputField" type="text" id="email"
                       ...
                       placeholder=${emailPlaceholder}
                               value="${requestScope.client.email}" required
                       title=${email}>
                <br>

                <label for="registrationDate">${registrationDate}: </label>
                <fmt:parseDate value="${requestScope.client.registrationDate}"
                ...
                <c:choose>
                    <c:when test="${requestScope.client.verified == true}">
                        <input class="checkbox" type="checkbox" id="verified" name="verified"
                               value="${requestScope.client.verified}"
                               checked="checked" disabled>
                    </c:when>
                    <c:otherwise>
                        <input class="checkbox" type="checkbox" id="verified" name="verified"
                               value="${requestScope.client.verified}" disabled>
                    </c:otherwise>
                </c:choose>
                <br>
                ...
                <c:choose>
                    <c:when test="${requestScope.client.active == true}">
                        <input class="checkbox" type="checkbox" id="active" name="active"
                               value="${requestScope.client.active}"
                               checked="checked">
                    </c:when>
                    <c:otherwise>
                        <input class="checkbox" type="checkbox" id="active" name="active"
