...
<fmt:message key="cinema.create" bundle="${resourceBundle}" var="title"/>
...
<div class="outer">
    <div class="center-padding grey shadow width50 back-white">
        <div class="padding-top-40">
            <form id="createCinemaForm" name="createCinemaForm"
                  action="${pageContext.request.contextPath}controller"
                  method="post">
                <input type="hidden" name="command" value="add_cinema">
                <p class="noteRed">
                    <c:if test="${sessionScope.errCreateCinemaMessage != null}">
                        <c:forEach var="errorMessages" items="${sessionScope.errCreateCinemaMessage}">
